...
if exists("c_comment_strings")
  ...
  try
    ...
    fun! s:Doxygen_Hilights_Base()
      SynLink doxygenCodeWord Comment
      SynLink doxygenCodeRegion Comment
      SynLink doxygenVerbatimRegion Comment
      ...
      SynColor doxygenSmallSpecial ctermfg=237 guifg=Black
      ...
      SynColor doxygenSpecial ctermfg=0 guifg=Black
    ...
    fun! s:Doxygen_Hilights()
      ...
      if (exists('g:doxygen_enhanced_color') && g:doxygen_enhanced_color) || (exists('g:doxygen_enhanced_colour') && g:doxygen_enhanced_colour)
        if &background=='light'
          ...
          SynColor doxygenBrief ctermfg=243 guifg=#7E8E91
          ...
          SynColor doxygenParamName cterm=italic ctermfg=59 guifg=#7E8E91 gui=italic

          " SynColor doxygenSpecialOnelineDesc cterm=bold ctermfg=LightCyan guifg=LightCyan gui=bold
          SynColor doxygenSpecialOnelineDesc ctermfg=238 guifg=#7E8E91

          " SynColor doxygenSpecialHeading cterm=bold ctermfg=LightBlue guifg=LightBlue gui=bold
          SynColor doxygenSpecialHeading cterm=bold ctermfg=Red guifg=LightBlue gui=bold
